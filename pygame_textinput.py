...
class TextInput:
    ...
    """
    def __init__(self, font_object = None,
                 font_size = 35,
                 antialias=True,
                 text_color=(0, 0, 0),
                 cursor_color=(0, 0, 1),
    ...
    def update(self, events):
        ...
        self.surface = self.font_object.render(self.before_string + self.input_string, self.antialias, self.text_color)
        ...
        if self.cursor_visible:
            cursor_y_pos = self.font_object.size(self.before_string + self.input_string[:self.cursor_position])[0]
